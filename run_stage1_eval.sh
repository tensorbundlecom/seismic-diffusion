...
/home/gms/miniconda3/bin/python ML/autoencoder/experiments/PaperRepro/evaluation/evaluate_stage1_autoencoder.py \
  ...
  --batch-size 64 \
  --num-workers 8 \
  --waveform-eval-samples 32 \
  --visual-samples-per-split 6
