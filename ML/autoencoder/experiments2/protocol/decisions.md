...
- `Impact`:
  ...
  - Run klasoru duzeni sabit:
    - `runs/exp001/run_YYYYMMDD_HHMM/config_resolved.yaml`
    - `runs/exp001/run_YYYYMMDD_HHMM/train.log`
    - `runs/exp001/run_YYYYMMDD_HHMM/checkpoints/`
    - `runs/exp001/run_YYYYMMDD_HHMM/metrics/`
    - `runs/exp001/run_YYYYMMDD_HHMM/plots/`
- `Status`: Frozen
- `Date`: 2026-02-24
- `Note`: Orta-katman/gecici dosyalar `checkpoints/tmp/` altinda tutulup run sonunda temizlenecek. `best_condgen_composite` tanimi `D013` ile sabitlenmistir.
...
- `Impact`:
  ...
  - `mid (2-8 Hz)`: sadece diagnostic, model secim kapisina dahil degil
