...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        default="ML/autoencoder/experiments/WBaseline/visualizations/post_training_ood_evaluation",
    ...
    wbaseline_chk = 'ML/autoencoder/experiments/WBaseline/checkpoints/wbaseline_external_best.pt'
