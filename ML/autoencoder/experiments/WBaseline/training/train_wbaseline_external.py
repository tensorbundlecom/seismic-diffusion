...
from ML.autoencoder.experiments.WBaseline.core.loss_utils import wbaseline_cvae_loss_function
...
def train_wbaseline_external():
    ...
    exp_dir = Path('ML/autoencoder/experiments/WBaseline')
    checkpoint_dir = exp_dir / 'checkpoints'
    checkpoint_dir.mkdir(parents=True, exist_ok=True)

    print('[INFO] Starting WBaseline training')
    ...
    print('[INFO] WBaseline training completed.')
