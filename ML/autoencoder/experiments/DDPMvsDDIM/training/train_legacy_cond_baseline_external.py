...
def parse_args():
    parser = argparse.ArgumentParser(description="Train isolated LegacyCondBaseline inside DDPMvsDDIM.")
    ...
    parser.add_argument(
        "--output-dir",
        default="ML/autoencoder/experiments/DDPMvsDDIM/runs/legacy_cond_baseline",
    )
...
def make_loader(dataset, batch_size, shuffle, collate_fn, num_workers, pin_memory):
...
def main():
    ...
    with open(history_path, "w", newline="") as history_file:
        ...
        print("[INFO] Starting isolated LegacyCondBaseline training")
        print(
            "[INFO] "
    ...
    print("[INFO] Isolated LegacyCondBaseline training completed.")
