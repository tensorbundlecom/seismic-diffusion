...
def main():
    parser = argparse.ArgumentParser(description="Train small-backbone geometry-conditioned full-cov CVAE on external HH dataset.")
    ...
    run_name = args.run_name or f"fullcov_geo_small_external_{ts}"
