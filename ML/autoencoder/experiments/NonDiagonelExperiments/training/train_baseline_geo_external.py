...
def main():
    parser = argparse.ArgumentParser(description="Train geometry-conditioned baseline CVAE on external HH dataset.")
    ...
    run_name = args.run_name or f"baseline_geo_external_{ts}"
