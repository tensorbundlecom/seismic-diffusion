# LegacyCondAblation Experiment

> Terminology note (2026-02-24): `W` in this folder refers to deterministic condition embedding, not StyleGAN latent `W-space`.
...
- mapping network (legacy `w` condition embedding)
- station identity
