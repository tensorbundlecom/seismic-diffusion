...
def parse_args():
    parser = argparse.ArgumentParser(description="Run LegacyCondAblation variant matrix.")
...
def main():
    ...
    train_script = "ML/autoencoder/experiments/LegacyCondAblation/training/train_w_ablation_external.py"
    logs_dir = Path("ML/autoencoder/experiments/LegacyCondAblation/logs")
