...
from ML.autoencoder.experiments.LegacyCondFullCov.core.loss_utils import wfullcov_loss_function
...
def train_wfullcov_external():
    ...
    exp_dir = Path('ML/autoencoder/experiments/LegacyCondFullCov')
    checkpoint_dir = exp_dir / 'checkpoints'
    checkpoint_dir.mkdir(parents=True, exist_ok=True)

    print('[INFO] Starting LegacyCondFullCov training')
    ...
    print('[INFO] LegacyCondFullCov training completed.')
