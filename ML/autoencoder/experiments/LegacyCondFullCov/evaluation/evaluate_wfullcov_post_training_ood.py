...
def main():
    parser = argparse.ArgumentParser(description='Evaluate WFullCov post-training OOD metrics.')
    ...
    parser.add_argument(
        '--output_dir',
        default='ML/autoencoder/experiments/LegacyCondFullCov/results',
        help='Output directory for metrics.',
    )
    parser.add_argument(
        '--output_name',
        default='post_training_wfullcov_comparison_metrics.json',
