...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        default="ML/autoencoder/experiments/NormalizingW/visualizations/post_training_ood_evaluation",
    ...
    wflow_chk = 'ML/autoencoder/experiments/NormalizingW/checkpoints/wflow_external_best.pt'
