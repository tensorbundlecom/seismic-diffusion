...
from ML.autoencoder.experiments.NormalizingW.core.loss_utils import wflow_cvae_loss_function
...
def train_wflow_external():
    ...
    exp_dir = Path('ML/autoencoder/experiments/NormalizingW')
    checkpoint_dir = exp_dir / 'checkpoints'
    checkpoint_dir.mkdir(parents=True, exist_ok=True)

    print('[INFO] Starting NormalizingW training')
    ...
    print('[INFO] NormalizingW training completed.')
