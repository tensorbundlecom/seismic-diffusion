...
run_if_needed "lsv_stage2_vae_base_ld64_b0p1_s43_logvfixv1" 43
run_if_needed "lsv_stage2_vae_base_ld64_b0p1_s44_logvfixv1" 44

echo "[$(date '+%Y-%m-%d %H:%M:%S')] ALL_STAGE2_BETA0P1_LOGVARFIX_S43S44_COMPLETED"
