...
from ML.autoencoder.experiments.FullCovariance.core.stft_dataset_fixed import SeismicSTFTDatasetWithMetadata, collate_fn_with_metadata
...
def train_experiment():
    ...
    dataset = SeismicSTFTDatasetWithMetadata(
        ...
        channels=['HH'], # Note: the dir itself is HH, but dataset might append HH
        magnitude_col='ML',
